...
class Export_pegawai_excel extends CI_Controller {
	
	public function __construct(){
		parent::__construct();
		
		$this->load->model('export_pegawai_excel_model');
	}
	
	public function index(){
		$data['karyawan'] = $this->export_pegawai_excel_model->view();
	...
	public function export(){
		...
		$ambildata = $this->export_pegawai_excel_model->export_pegawai();
        ...
        if(count($ambildata)>0){
            ...
            $objPHPExcel->getProperties()
                  ->setCreator("UCHIHA KIMOCHI") //creator
                    ->setTitle("Data Karyawan");  //file title
        ...
        $objDrawing->setWorksheet($objPHPExcel->getActiveSheet());
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', "DAFTAR KARYAWAN"); 
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            ...
            $val = array("NIP ","Nama Karyawan","Jabatan","Jenis Kelamin","Tempat Lahir","Tanggal Lahir");
            ...
            foreach ($ambildata as $frow){
                ...
                $objset->setCellValue("A".$baris, $frow->nip); //membaca data nama
                $objset->setCellValue("B".$baris, $frow->nama_depan." ".$frow->nama_belakang); //membaca data alamat
                $objset->setCellValue("C".$baris, $frow->nama_jabatan); //membaca data kontak
                $objset->setCellValue("D".$baris, $frow->jk);
                $objset->setCellValue("E".$baris, $frow->tempat_lahir);
                $objset->setCellValue("F".$baris, $frow->tgl_lahir);
		...
		header('Content-Disposition: attachment;filename="Karyawan.xlsx"'); // Set nama file excel nya
