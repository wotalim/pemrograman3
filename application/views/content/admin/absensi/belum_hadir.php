              ...
              <div class="card">
                <div class="card-header bg-danger text-white">
                  ...
                  <span class="pull-right">
                    <a class="btn btn-xs btn-info" href="<?php echo site_url("absensi/form_absen_kehadiran/").$row->nip;?>" title="Klik Untuk Absensi Kehadiran '<?php echo $row->nama_depan;?>'"><i class="fa fa-check"></i></a>
                  </span>
                </div>
