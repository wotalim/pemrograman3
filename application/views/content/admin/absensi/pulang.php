    ...
    <div class="panel panel-default" style="background: #ffffff;">
					<div class="panel-body tabs">
						<ul class="nav nav-pills">
							...
							<li class="active"><a href="<?php echo site_url('absensi/pulang')?>"><em class='fa fa-sign-out'>&nbsp;</em>Pulang</a></li>
            ...
            <hr class="style1">
						<div class="tab-content">
							<div class="tab-pane fade in active" id="pulang">
              <div class="row">
              <?php 
              $tanggal = date("Y-m-d");
              foreach($querytampilPulang->result() as $row){
                    ...
                    <div class="card">
                      <div class="card-header bg-warning text-white">
                        ...
                        <span class="pull-right">
                          <a class="btn btn-xs btn-info" href="<?php echo site_url("absensi/form_informasi_pulang/").$row->id_absensi;?>" title="Klik Untuk Absensi Pulang"><i class="fa fa-check"></i></a>
                        </span>
                      </div>
